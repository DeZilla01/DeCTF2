...
Current Progress:
Pre-game functionality works. Currently working on making the CTF gamemode functional aswell as basic features. After this, BaseKit and HeavyKit. Looking at maybe using OldCombatMechanics plugin as depency.
